...
| *Solver*   | *Type*                   |                                  |
|----------+------------------------+----------------------------------|
| [[https://github.com/chuffed-chuffed/chuffed][Chuffed]]  | Lazy clause generation | Fast for combinatorial problems  |
| [[https://github.com/Gecode/gecode][Gecode]]   | Finite domain          | Mature, broad constraint support |
| [[https://github.com/MiniZinc/libminizinc][OR-Tools]] | LP/MIP/CP              | Google's optimization suite      |
| ...      |                        |                                  |
|----------+------------------------+----------------------------------|
